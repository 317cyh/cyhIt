...
public class sms {
    ...
    private static final String accessKeyId = "LTAI4FdGXCoF2qKGLUNvfx4M"; //TODO: 这里要写成你自己生成的
    private static final String accessKeySecret = "8DF3Hm2pz5gidXTfSvhGi85NmTdnhL";//TODO: 这里要写成你自己生成的
    ...
    public static String sendSms(String phone) throws ClientException {
        ...
        /* 必填:短信签名-可在短信控制台中找到 */
        request.setSignName("桃花侠"); //TODO: 这里是你短信签名
        /* 必填:短信模板code-可在短信控制台中找到 */
        request.setTemplateCode("SMS_175060969"); //TODO: 这里是你的模板code
